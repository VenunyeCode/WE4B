...
document.addEventListener('DOMContentLoaded', function (e) {
  (function () {
    // Variables
    const interdiction_text = document.querySelector('.interdiction_text'),
      btnReset = document.querySelector('.btn-reset');
    let cleave;

    // Credit Card
    function initCleave() {
      if (interdiction_text) {
        cleave = new Cleave(interdiction_text, {
          creditCard: true,
    ...
    FormValidation.formValidation(document.getElementById('postForm'), {
      fields: {
        modalAddCard: {
          validators: {
            notEmpty: {
